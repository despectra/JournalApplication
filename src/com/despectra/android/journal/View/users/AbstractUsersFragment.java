...
public class AbstractUsersFragment extends EntitiesListFragment implements ApiServiceHelper.FeedbackApiClient {
    ...
    private AddEditSimpleUserDialog.DialogListener mStudentDialogListener = new AddEditSimpleUserDialog.DialogListener() {
        @Override
                ...
                case R.id.action_edit:
                    ...
                    if (mAddEditDialog == null) {
                        mAddEditDialog = AddEditSimpleUserDialog.newInstance(listItemLocalId, listItemRemoteId,
                                "Добавление ученика", "Редактирование ученика",
                                name, middlename, surname, login);
                    }
                    mAddEditDialog.setDialogListener(mStudentDialogListener);
    ...
    public static AbstractUsersFragment newInstance(String groupName, long localGroupId, long remoteGroupId) {
        AbstractUsersFragment fragment = new AbstractUsersFragment();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add_student:
                if (mAddEditDialog == null) {
                    mAddEditDialog = AddEditSimpleUserDialog.newInstance(-1, -1, "Добавление ученика", "Редактирование ученика", "", "", "", "");
                }
                mAddEditDialog.setDialogListener(mStudentDialogListener);
